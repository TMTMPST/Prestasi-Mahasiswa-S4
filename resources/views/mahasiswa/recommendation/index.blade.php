                                        ...
                                        @foreach ($competitions as $index => $data)
                                            <tr>
                                                <td class="text-center">
                                                    <span
                                                        class="badge {{ $loop->iteration <= 3 ? 'bg-warning' : 'bg-secondary' }}">
                                                        {{ $loop->iteration }}
                                                    </span>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <br>
                                                    <small
                                                        class="text-muted">{{ $data['competition']->penyelenggara }}</small>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        $startDate = \Carbon\Carbon::parse(
                                                            $data['competition']->tgl_dibuka,
                                                        );
                                                        $endDate = \Carbon\Carbon::parse(
                                                            $data['competition']->tgl_ditutup,
                                                        );
                                                    @endphp
                                                    @if ($today < $startDate)
                                                ...
                                                <td>
                                                    @if ($data['competition']->link_lomba)
                                                        <a href="{{ $data['competition']->link_lomba }}" target="_blank"
