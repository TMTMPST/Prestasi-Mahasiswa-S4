                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <p class="mb-2">
                                                                ...
                                                                <small
                                                                    class="text-success">{{ \Carbon\Carbon::parse($lomba->tanggal_mulai)->format('d M Y') }}</small>
                                                            </p>
                                                            <p class="mb-0">
                                                                <strong class="text-maroon">Selesai:</strong><br>
                                                                <small
                                                                    class="text-danger">{{ \Carbon\Carbon::parse($lomba->tanggal_selesai)->format('d M Y') }}</small>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
