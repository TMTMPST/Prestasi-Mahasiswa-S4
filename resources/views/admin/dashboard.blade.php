                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <p class="mb-2">
                                                            ...
                                                            <small class="text-success">{{ $lomba->tgl_dibuka ? \Carbon\Carbon::parse($lomba->tgl_dibuka)->format('d M Y') : 'Tidak diset' }}</small>
                                                        </p>
                                                        <p class="mb-0">
                                                            <strong class="text-maroon">Selesai:</strong><br>
                                                            <small class="text-danger">{{ $lomba->tgl_ditutup ? \Carbon\Carbon::parse($lomba->tgl_ditutup)->format('d M Y') : 'Tidak diset' }}</small>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
