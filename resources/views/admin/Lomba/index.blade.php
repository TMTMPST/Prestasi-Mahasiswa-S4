                    ...
                    <tbody>
                        @foreach ($lombas as $lomba)
                            <tr>
                                ...
                                <td>{{ $lomba->hadiah }}</td>
                                <td>{{ $lomba->verifikasi }}</td>
                                <td>
                                    <a href="/manajemen-lomba/edit/{{ $lomba->id_lomba }}" class="btn btn-primary"><i class="bi bi-pencil-square"></i> Edit</a>
                                    {{-- <form action="/manajemen-lomba/delete/{{ $lomba->id_lomba }}" method="POST"
                                    ...
                                    <a href="#" class="btn btn-maroon btn-sm">
