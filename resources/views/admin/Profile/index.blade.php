    ...
    <div class="card dashboard-card mb-4">
        ...
        <div class="card-body bg-white rounded-bottom" style="border-radius:0 0 18px 18px;">
            <table class="table table-borderless mb-0">
                <tbody>
                <tr>
                    <th class="text-maroon" style="width:180px;">Username</th>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge bg-primary">{{ $admin->level }}</span>
                    </td>
                </tr>
                </tbody>
            </table>
            <a href="{{ route('admin.profile.update_profile', $admin->username) }}" class="btn btn-maroon mt-4 px-4">
