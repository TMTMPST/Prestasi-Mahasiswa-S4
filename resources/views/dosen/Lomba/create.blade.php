...
<form id="formTambahLomba" method="POST" action="{{ route('lomba.store') }}" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            <label class="form-label custom-label">Link Lomba</label>
            <input type="url" class="form-control custom-form-control" name="link_lomba" placeholder="https://contoh.com/lomba" required>
        </div>
    </div>
    ...
    document.addEventListener('submit', function (e) {
        if (e.target && e.target.id === 'formTambahLomba') {
            ...
            .then(response => {
                ...
                location.reload(); // Atau panggil fungsi AJAX lain
            })
            .catch(error => {
