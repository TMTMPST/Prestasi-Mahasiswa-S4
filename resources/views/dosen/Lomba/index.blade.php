                ...
                <div class="col">
                    ...
                    <div class="card shadow-sm h-100 custom-card">
                        ...
                        <div class="card-body" style="font-size: 1rem;">
                            ...
                            <p><strong>Mulai:</strong> {{ \Carbon\Carbon::parse($lomba->tanggal_mulai)->format('d M Y') }}
                            </p>
                            <p><strong>Selesai:</strong>
                                {{ \Carbon\Carbon::parse($lomba->tanggal_selesai)->format('d M Y') }}</p>
                                    ...
                                    <div class="card-body p-2">
                                        <div class="d-flex justify-content-center">
                                            <a href="{{ $lomba->link_lomba }}" target="_blank"
                                                class="btn custom-btn-primary btn-sm w-100">Lihat Detail</a>
                                            <a href="https://docs.google.com/forms/d/19H28i0qObFYdjkMxXbRN_eOjimVQlGO1L6rKW6-sqXc/edit"
                                                target="_blank" class="btn custom-btn-success btn-sm w-100">Daftar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
